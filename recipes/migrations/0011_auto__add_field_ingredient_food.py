...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('recipes_ingredient', 'food', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nutrition.Food'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ingredient.food'
        db.delete_column('recipes_ingredient', 'food_id')
    ...
    models = {
        ...
        'recipes.ingredient': {
            ...
            'food': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nutrition.Food']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
