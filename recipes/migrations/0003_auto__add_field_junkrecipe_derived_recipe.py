...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JunkRecipe.derived_recipe'
        db.add_column('recipes_junkrecipe', 'derived_recipe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Recipe'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JunkRecipe.derived_recipe'
        db.delete_column('recipes_junkrecipe', 'derived_recipe_id')
