...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IngredientWeight'
        db.create_table('recipes_ingredientweight', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ingredient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.Ingredient'])),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipes.MeasurementUnit'])),
            ('weight', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('recipes', ['IngredientWeight'])


    def backwards(self, orm):
        
        # Deleting model 'IngredientWeight'
        db.delete_table('recipes_ingredientweight')
