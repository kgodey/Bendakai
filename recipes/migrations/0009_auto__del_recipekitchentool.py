...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field tools on 'Recipe'
        db.create_table('recipes_recipe_tools', (
        ...
        db.create_unique('recipes_recipe_tools', ['recipe_id', 'kitchentool_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tools on 'Recipe'
        db.delete_table('recipes_recipe_tools')
