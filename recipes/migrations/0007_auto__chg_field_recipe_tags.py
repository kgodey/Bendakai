...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.tags'
        db.alter_column('recipes_recipe', 'tags', self.gf('tagging.fields.TagField')())


    def backwards(self, orm):
        
        # Changing field 'Recipe.tags'
        db.alter_column('recipes_recipe', 'tags', self.gf('tagging_autocomplete.models.TagAutocompleteField')())
