...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserKitchenTool'
        db.create_table('recipes_userkitchentool', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tools', to=orm['auth.User'])),
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['recipes.KitchenTool'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal('recipes', ['UserKitchenTool'])


    def backwards(self, orm):
        
        # Deleting model 'UserKitchenTool'
        db.delete_table('recipes_userkitchentool')
    ...
    models = {
        ...
        'recipes.recipe': {
            ...
            'tools': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['recipes.KitchenTool']", 'null': 'True', 'blank': 'True'}),
        ...
        'recipes.userkitchentool': {
            'Meta': {'object_name': 'UserKitchenTool'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'users'", 'to': "orm['recipes.KitchenTool']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tools'", 'to': "orm['auth.User']"})
        },
